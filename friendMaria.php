    ...
    <section class="home">
        ...
        <div class="profile-container">
            <div class="profile-details">
                <div class="pd-left">
                    <div class="pd-row">
            <img src="images/profile2.jpg" class="dp-img" alt="">
            <div>
            <h3 class="mt-0 mb-0" ><?php echo 'Maria Xien Ci' ?> </h3>
            <p>6 Friends</p>
        ...
        <div class="pd-right">
            ...
            <div class="about-section">
                <div class="bio">
                    <h1>About Me</h1>
                      <p>Hi, My name is Maria, and I live in <?php echo $_SESSION['ses_address']; ?>.</p>
                </div>
            </div>
